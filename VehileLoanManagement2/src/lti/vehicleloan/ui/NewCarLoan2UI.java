...
public class NewCarLoan2UI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NewCarLoan2UI frame = new NewCarLoan2UI(c,carName,loan);
	 ...
	 * Create the frame.
	 */
	public NewCarLoan2UI(Customer c, String carName,Loan loan) {
		...
		labelPrincipalAmount.setBounds(35, 221, 202, 31);
		...
		labelDisplayEMI.setBounds(719, 196, 123, 36);
		...
		labelDisplayTotalInterest.setBounds(692, 303, 202, 24);
		...
		btnNewButton_1.setBounds(12, 642, 168, 36);
		...
		btnNewButton_2.setBounds(251, 642, 151, 36);
		...
		labelCarPrice.setBounds(69, 444, 168, 26);
		...
		JLabel lblNewLabel_3 = new JLabel("4000");
		...
		JRadioButton rb96 = new JRadioButton("ROI of 9.5% for Loan Term of 96 months\r\n");
		...
		JRadioButton rb86 = new JRadioButton("ROI of 10.5% for Loan Term of 86 Months");
		...
		JRadioButton rb77 = new JRadioButton("ROI of 11.5% for a Loan Term of 77 Months");
		...
		JRadioButton rb74 = new JRadioButton("ROI of 12% for a Loan Term of 74 Months");
		...
		buttonEMI.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(textCarPrice.getText().isEmpty() || textPrincipal.getText().isEmpty()) {
					...
					int el = lsl.checkLoanEligibiltyNewCar(principal, priceCar);
					if(el==1) {
						if(rb96.isSelected()) {
							double rate = 9.5;
							int term = 96;
		...
		buttonEMI.setBounds(317, 487, 168, 49);
		...
		buttonApplyLoan.setBounds(692, 594, 167, 46);
